...
class TestConstructorPage:
    ...
    def test_open_orders_list_by_link(self, get_browser):
        driver = get_browser
        constructor_page = ConstructorPage(driver)
        ...
        orders_page = OrdersPage(driver)
        orders_page.wait_for_load_element(MainPageLocators.TOTAL_TODAY)
    ...
    def test_click_ingredient_modal_window(self, get_browser):
        driver = get_browser
        constructor_page = ConstructorPage(driver)
        constructor_page.open_constructor_page()
    ...
    def test_close_ingredient_details_modal_window(self, get_browser):
        driver = get_browser
        constructor_page = ConstructorPage(driver)
        constructor_page.open_constructor_page()
        constructor_page.click_ingredient_link()
    ...
    def test_append_ingredient_in_order_counter_more(self, get_browser):
        driver = get_browser
        constructor_page = ConstructorPage(driver)
        constructor_page.open_constructor_page()
    ...
    def test_checkout_order_by_authorized_user(self, get_browser, create_new_user_by_api, login_new_user):
